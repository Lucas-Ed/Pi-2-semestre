...
if ($resultTotal && $rowTotal = $resultTotal->fetch_assoc()) {
    $total_agend = $rowTotal['total_agend'];
} else {
    $total_agend = 0;
}
?>
                        ...
                        <tr>
                            ...
                            <td>
                                <i class="bi bi-pencil-square me-2 icon-action btn-editar" title="Editar"
                                    ...
                                    data-bs-target="#modalEditar" style="color: #0097B2;">
                                </i>
                                <i class="bi bi-card-text icon-action btn-detalhes" title="Detalhes"
                                    ...
                                    data-bairro="<?= htmlspecialchars($row['bairro']) ?>" style="color: #0097B2;">
                                </i>
                                <!-- Botão de remover -->
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0" style="border-radius: 15px; background-color: #0097B2;">
                ...
                <div class="modal-body px-4 py-4 text-white">
                    ...
                    <div class="p-2 rounded m-0" style="box-shadow: 0 0 3px inset #444; border-radius: 8px;">
                    ...
                    <div class="mb-3">
                        <h6 class="p-3 m-0">Use o mapa para buscar o veículo!</h6>
                        <div class="d-flex justify-content-between">
                            <a id="btn-waze" href="#" target="_blank"
                                class="btn d-flex align-items-center justify-content-center"
                                style="width: 45%; border-radius: 10px; background-color: white; color: #0097B2;">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        detalhesBtns.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                document.getElementById('modal-telefone').textContent = btn.dataset
                    .telefone;
                ...
                document.getElementById('modal-numero').textContent = btn.dataset
                    .numero;
                document.getElementById('modal-bairro').textContent = btn.dataset
                    .bairro;
            });
        });
    });

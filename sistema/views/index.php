...
<body class="d-flex flex-column min-vh-100 bg-light">
    ...
    <header class="text-white py-3">
        <div class="container d-flex justify-content-between align-items-center">
            <!-- Logo à esquerda -->
            <img src="../public/uploads/img/logo_empresa.svg" alt="Logo Empresa" class="img-fluid"
                style="max-width: 200px;">

            <!-- Botão de login à direita -->
            <a href="./login.php" class="btn px-3 d-flex justify-content-center align-items-center"
                style="background-color: #0097B2; color: white; border-radius: 10px; width: 150px; height: 50px; box-shadow: inset 0 0 10px #444; border: none; text-decoration: none;">
                Login
            </a>
        </div>
    </header>
    ...
    <main class="text-center  d-flex flex-column flex-grow-1 w-100 px-3 align-items-center justify-content-start pt-5">

        <div class=" mb-5" style="max-width: 800px;">
            <h2 class="pt-2" style="color: #00a3c7;">Embelezamento Automotivo</h2>

            <p class="text-secondary text-center m-0">
                Oferecemos serviços de lavagem automotivo, como polimento, cristalização, higienização e vitrificação.
                Usamos produtos premium e técnicas avançadas para garantir brilho e proteção. Agende seu atendimento
                facilmente pelo nosso sistema de agendamento online.
            </p>
        </div>

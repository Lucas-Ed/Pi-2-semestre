            ...
            <form action="../controllers/send_token.php" method="POST" style="margin-bottom: 1rem;">
                ...
                <div class="mb-3">
                    ...
                    <a href="./login.php" class="btn d-flex align-items-center justify-content-center w-50 me-2"
                       style="
                       margin-top: 25px; margin-left: 75px; background-color: #00a3c7; color: white; border-radius: 10px; height: 55px; box-shadow: 0 0 5px rgba(0, 0, 0, 0.50); font-weight: 500;">
                        Voltar
                    </a>
